...
Session-based authentication and role-based authorization (RBAC) should be used to ensure that only authorized users can access administrative functionality.
